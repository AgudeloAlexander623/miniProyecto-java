 ...
 * alinear cosas de la etiqueta: setVertical
 * (etiquetas.setVerticalAlignament(JLabel.center)).
...
/*
 * los paneles son intersecciones que nos permiten mejorar el aspecto de la
 * app(tienen cierto parecido a los DIV en HTML)
 * en esta parte mostrare las cosas aprendidas en el curso de como implementar
 * distintos paneles sobre otros*
 * 
 * import javax.swing.*;
...
/*
 * con este codigo de ejemplo podemos crear un boton basico y agregarle ciertas
 * funciones
 * 
 ...
 * miVentana() {
 * 
 * //cremos un icono con una imagen
 * ImageIcon imagen = new ImageIcon("imagen.jpg");
 * 
 * 
 * //creamos el boton
 * boton = new JButton("soy un btn");
 * boton.setBounds(30,20,220,150);
